...
예제 T-SQL은 `sql2python/examples/sql/` 아래 BookStore용 `usp_*.sql` 네 개를 둡니다.
...
# 프롬프트만 미리보기(모델 호출 없음)
python main.py preview --backend gemma --input examples/sql/usp_modified_book_storebook.sql
